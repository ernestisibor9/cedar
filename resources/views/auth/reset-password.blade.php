...
<head>
    ...
    <title>Cedar - Reset Password</title>
</head>
            ...
            <div class="card forgot-box">
                <div class="card-body">
                    <div class="p-3">
                        ...
                        <p class="text-muted">We received your reset password request. Please enter your new password!
                        </p>
                        <span style="color: green; font-weight:bold"><x-auth-session-status class="mb-4"
