            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                    ...
                    <ul class="generic-list-item pt-4">
                        ...
                        <li><a href="mailto:info@cedargrowthconsult.com"
                                class="text-white">info@cedargrowthconsult.com</a></li>
                ...
                <div class="footer-item">
                    ...
                    <ul class="generic-list-item">
                        @foreach ($courses as $course)
                            <li><a href="{{ url('course/details/' . $course->id . '/' . $course->course_name_slug) }}"
                                    class="text-white">{{ substr($course->course_name, 0, 20) }}</a></li>
                        @endforeach
                    </ul>
                </div><!-- end footer-item -->
            </div><!-- end col-lg-3 -->
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <p class="copy-desc text-white">&copy; @php
                        echo date('Y');
                    @endphp Cedar Growth Consult. All Rights Reserved.
                        Powered by <a href="https://www.justimagin.com.ng" class="text-white">JUSTIMAGIN</a></p>
                </div><!-- end col-lg-6 -->
                {{-- <div class="col-lg-6">
