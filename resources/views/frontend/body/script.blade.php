    ...
    function wishlist() {
        $.ajax({
            ...
            <div class="card card-item">
                ...
                <div class="card-body">
                    <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">${value.course.course_title}</h6>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="icon-element icon-element-sm shadow-sm cursor-pointer" data-toggle="tooltip" data-placement="top" title="Remove from Wishlist"  id="${value.id}" onclick="wishlistRemove(this.id)"><i class="la la-remove"></i></div>
                    </div>
                </div>
            </div>
        </div>
