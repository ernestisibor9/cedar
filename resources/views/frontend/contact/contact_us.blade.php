    ...
    <section class="contact-area section--padding position-relative">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 responsive-column-half">
                    <div class="info-box">
                        ...
                        <p class="info__text">Ilkeston, Derbyshire. DE7 4PX United Kingdom.</p>
                    </div><!-- end info-box -->
                </div><!-- end col-lg-3 -->
                <div class="col-lg-4 responsive-column-half">
                    <div class="info-box">
                        ...
                        <p class="info__text">info@cedargrowthconsult.com</p>
                        <p class="info__text">
                            Elizabeth.o@Cedargrowthconsult.com
                        </p>
                    </div><!-- end info-box -->
                </div><!-- end col-lg-3 -->
                <div class="col-lg-4 responsive-column-half">
                    <div class="info-box">
                        ...
                        <p class="info__text">+44 7771 2224 76</p>
                        <p class="info__text">+234 707 2485 480</p>
                    </div><!-- end info-box -->
                </div><!-- end col-lg-3 -->
            </div><!-- end row -->
                ...
                <div class="col-lg-5">
                    <div class="contact-content pb-5">
                        <div class="section-heading">
                            ...
                            <p class="section__desc">Lorem ipsum is simply free text dolor sit amett quie adipiscing elit.
                                When an unknown printer took a galley. quiaies lipsum dolor sit atur adip scing</p>
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            <form method="post" action="php/contact.php" class="contact-form">
                                ...
                                <div class="btn-box">
                                    <button id="send-message-btn" class="btn theme-btn" type="submit">Send
                                        Message</button>
                                </div><!-- end btn-box -->
                            </form>
                        </div><!-- end card-body -->
            ...
            <div class="row pt-30px">
                <div class="col-lg-12">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m23!1m12!1m3!1d126828.04073510614!2d3.2595648556233114!3d6.600073234497362!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m8!3e6!4m0!4m5!1s0x103b8d7c33eb87b3%3A0xfc23c9556f669273!2sInfinite%20Grace%20Plaza%20Plot%204%20Oyetubo%20Street%20Lagos%20NG%2C%20off%20Obafemi%20Awolowo%20Wy%2C%20Ikeja%2C%20100001!3m2!1d6.6000782!2d3.3419676999999997!5e0!3m2!1sen!2sng!4v1724416066005!5m2!1sen!2sng" width="1200" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe><!-- end map-container -->
                </div><!-- end col-lg-12 -->
            </div><!-- end row -->
        </div><!-- end container -->
    </section>
