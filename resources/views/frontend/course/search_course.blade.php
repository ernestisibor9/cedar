    ...
    <div class="container">
        <div class="filter-bar mb-4">
            <div class="filter-bar-inner d-flex flex-wrap align-items-center justify-content-between">
                <p class="fs-14">We found <span class="text-black">{{ count($courses) }}</span>
                    {{ count($courses) < 2 ? 'course' : 'courses' }} available for you</p>
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item card-preview" data-tooltip-content="">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><a href="teacher-detail.html">Duration {{ $course->duration }}</a>
                            </p>
