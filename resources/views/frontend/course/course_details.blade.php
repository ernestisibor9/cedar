                ...
                <div class="bread-btn-box pt-3">
                    <button class="btn theme-btn theme-btn-sm theme-btn-transparent lh-28 mr-2 mb-2">
                        ...
                        <span class="swapping-btn" data-text-swap="Wishlisted" data-text-original="Wishlist"
                            id="{{ $course->id }}" onclick="addToWishList(this.id)">Wishlist</span>
                    </button>
                ...
                <div class="course-details-content-wrap pt-90px">
                    ...
                    <div class="course-overview-card pt-4">
                        <h3 class="fs-24 font-weight-semi-bold pb-4">
                            {{ count($paidCourses) === 0 ? '' : 'Students also bought' }}</h3>
                        <div class="view-more-carousel owl-action-styled">
                            @foreach ($paidCourses as $coursePaid)
                                <div class="card card-item card-item-list-layout border border-gray shadow-none">
                                    <div class="card-image">
                                        <a href="course-details.html" class="d-block">
                                            <img class="card-img-top"
                                                src="{{ asset($coursePaid->course->course_image) }}"
                                                alt="Card image cap">
                                        </a>
                                    ...
                                    <div class="card-body">
                                        <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">{{ $coursePaid->course->level }}
                                            Levels</h6>
                                        <h5 class="card-title"><a
                                                href="course-details.html">{{ $coursePaid->course->course_name }}
                                            </a></h5>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <p class="card-price text-black font-weight-bold">
                                                ${{ number_format($coursePaid->course->selling_price, 2) }} <span
                        ...
                        <div class="card-body">
                            ...
                            <ul class="generic-list-item">
                                @foreach ($categories as $cat)
                                    <li><a
                                            href="{{ url('category/course/list/' . $cat->id) }}">{{ $cat->category_name }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                                ...
                                <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="text-black font-weight-semi-bold lh-18 fs-15">
                                            ${{ number_format($relatedCourse->selling_price, 2) }} <span
                                                class="before-price fs-14">${{ number_format($relatedCourse->discount_price, 2) }}</span>
                                        </p>
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <div class="view-all-course-btn-box">
                                <a href="{{ route('browse.all.course') }}" class="btn theme-btn w-100">View All
        ...
        <div class="related-course-wrap">
            ...
            <div class="view-more-carousel-2 owl-action-styled">
                @foreach ($moreCourses as $moreCourse)
                    <div class="card card-item">
                        <div class="card-image">
                            <a href="{{ url('course/details/' . $moreCourse->id . '/' . $moreCourse->course_name_slug) }}"
                                class="d-block">
                                <img class="card-img-top" src="{{ asset($moreCourse->course_image) }}"
                                    alt="Card image cap">
                            </a>
                            {{-- <div class="course-badge-labels">
                                <div class="course-badge">Bestseller</div>
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title"><a
                                    href="{{ url('course/details/' . $moreCourse->id . '/' . $moreCourse->course_name_slug) }}">{{ $moreCourse->course_name }}
                                    2021</a></h5>
                            <p class="card-text"><a href="#">Cedar</a></p>
                            <div class="rating-wrap d-flex align-items-center py-2">
                                @php
                                    $reviewcount = App\Models\Review::where('course_id', $moreCourse->id)
                                        ->where('status', 1)
                                        ->latest()
                                        ->get();
                                    $avarage = App\Models\Review::where('course_id', $moreCourse->id)
                                        ->where('status', 1)
                                        ->avg('rating');
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <p class="card-price text-black font-weight-bold">
                                    ${{ number_format($moreCourse->selling_price, 2) }}<span
                                        class="before-price font-weight-medium"></span></p>
                                <div class="icon-element icon-element-sm shadow-sm cursor-pointer"
                                    title="Add to Wishlist" id="{{ $moreCourse->id }}"
                                    onclick="addToWishList(this.id)"><i class="la la-heart-o"></i></div>
                            </div>
                        </div><!-- end card-body -->
                    </div>
                ...
                <div class="copy-to-clipboard">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control form--control copy-input pl-3"
                            value="http://localhost:8000/{{ Request::path() }}">
        ...
        <div class="modal-content">
            <div class="modal-header border-bottom-gray">
                <div class="pr-2">
                    ...
                    <p class="pt-1 fs-14 lh-24">Flagged content is reviewed by Cedar Consult Growth staff to determine
                        whether it
            ...
            <div class="modal-body">
                <form method="post" action="">
                    ...
                    <div class="input-box">
                        ...
                        <div class="form-group">
                            <textarea class="form-control form--control pl-3" name="report_message"
