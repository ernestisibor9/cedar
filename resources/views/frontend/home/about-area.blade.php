        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="about-content pb-5">
                    <div class="section-heading">
                        ...
                        <h2 class="section__title">Benefits of Learning With Cedar</h2>
                        <span class="section-divider"></span>
                        <p class="section__desc">
                            At Cedar Growth Consult, we believe in your journey of continuous learning. That is why we
                            offer lifetime access to our courses, with this unique advantage, you can revisit and review
                            the material at your pace
                        </p>
            ...
            <div class="col-lg-5 ml-auto">
                <div class="generic-img-box">
                    <img src="{{ asset('frontend/images/comchild2.jpg') }}"
                        data-src="{{ asset('frontend/images/comchild2.jpg') }}" alt="About image"
