            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text">Teach what you love. Cedar gives you the tools to create a course.</p>
                ...
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        <img src="images/img-loading.png" data-src="images/small-img-4.jpg" alt="card image"
                            class="img-fluid rounded-full lazy">
                        <h5 class="card-title pt-4 pb-2">Cedar for Business</h5>
                        <p class="card-text">Get unlimited access to 5,000+ of Cedar's top courses for your team</p>
                        <div class="btn-box mt-20px">
                            <a href="for-business.html" class="btn theme-btn theme-btn-sm theme-btn-white lh-30"><i
                                    class="la la-briefcase mr-1"></i>Get cedar for business</a>
                        </div><!-- end btn-box -->
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
