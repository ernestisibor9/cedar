<!--======================================
        START ABOUT AREA
======================================-->
<section class="about-area section--padding overflow-hidden" style="background-color: #395072">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="about-content pb-5">
                    <div class="section-heading">
                        <h5 class="ribbon ribbon-lg mb-2">REGISTER YOUR CHILD TODAY</h5>
                        <h2 class="section__title text-white">We Give 99.9% Assurance To Get Your Child Certified</h2>
                        <span class="section-divider"></span>
                        <p class="section__desc text-white">
                            Please stop thinking that early coding education for your child is a bad idea… The world is
                            evolving, technology is gradually taking over the whole world…
                            One of the ways to help your child stand out in this world and avoid being replaced by AI in
                            the future is to introduce them early to coding. Confused about what early coding education
                    ...
                    <div class="row pt-4 pb-3">
                        <div class="col-lg-4 responsive-column-half">
                            <div class="info-icon-box mb-3 ">
                                ...
                                <h4 class="fs-20 font-weight-semi-bold pt-3 text-white">130,000 Courses</h4>
                        ...
                        <div class="col-lg-4 responsive-column-half">
                            <div class="info-icon-box mb-3">
                                ...
                                <h4 class="fs-20 font-weight-semi-bold pt-3 text-white">Live Learning</h4>
                            </div><!-- end info-icon-box -->
                        </div><!-- end col-lg-4 -->
                        <div class="col-lg-4 responsive-column-half">
                            <div class="info-icon-box mb-3">
                                ...
                                <h4 class="fs-20 font-weight-semi-bold pt-3 text-white">Expert Teachers</h4>
                            </div><!-- end info-icon-box -->
                        </div><!-- end col-lg-4 -->
                    </div><!-- end row -->
                    <div class="btn-box">
                        <a href="about.html" class="btn theme-btn">Enroll Now<i
            ...
            <div class="col-lg-5 ml-auto">
                <div class="generic-img-box">
                    <img src="{{ asset('frontend/images/comchild3.jpg') }}"
                        data-src="{{ asset('frontend/images/comchild3.jpg') }}" alt="About image"
