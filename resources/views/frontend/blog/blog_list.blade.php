                                ...
                                <div class="card card-item">
                                    <div class="card-image">
                                        <a href="{{ url('blog/details/' . $item->post_slug) }}" class="d-block">
                                            <img class="card-img-top lazy" src="{{ asset($item->post_image) }}"
                                                class="my-img-blog" data-src="{{ asset($item->post_image) }}"
                                                alt="Card image cap">
                                        </a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul
                                            ...
                                            <li class="d-flex align-items-center">By &nbsp; <a href="#">Admin </a>
                                            </li>
                                            <li class="d-flex align-items-center"><a href="#">{{ count($comments) }}
                                                    Comments</a></li>
                                            ...
                                            <div class="share-wrap">
                                                <ul class="social-icons social-icons-styled">
                                                    ...
                                                    {{-- <li class="mr-0"><a href="#" class="instagram-bg"><i
                                                                class="la la-instagram instagram-share"></i></a></li> --}}
                                                </ul>
                                ...
                                @foreach ($post as $dpost)
                                    <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                        <a href="{{ url('blog/details/' . $dpost->post_slug) }}" class="media-img">
                                            <img class="mr-3" src="{{ asset($dpost->post_image) }}" class=""
