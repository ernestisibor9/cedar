...
@section('userdashboard')
    ...
    @php
        ...
        $enrollStudent = App\Models\Payment::where('user_id', $id)->latest()->get();
        $wishList = App\Models\Wishlist::where('user_id', $id)->latest()->get();
        $review = App\Models\Review::where('user_id', $id)->latest()->get();
            ...
            <div class="card card-item dashboard-info-card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="pl-4">
                        ...
                        <h5 class="card-title pt-2 fs-26">{{count($enrollStudent)}}</h5>
                    </div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div><!-- end col-lg-4 -->
            ...
            <div class="card card-item dashboard-info-card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="pl-4">
                        ...
                        <h5 class="card-title pt-2 fs-26">{{count($wishList)}}</h5>
                    </div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div><!-- end col-lg-4 -->
        <div class="col-lg-4 responsive-column-half">
            <div class="card card-item dashboard-info-card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="pl-4">
                        <p class="card-text fs-18">Reviews</p>
                        <h5 class="card-title pt-2 fs-26">{{count($review)}}</h5>
                    </div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div>
            ...
            <div class="card card-item dashboard-info-card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="pl-4">
                        ...
                        <h5 class="card-title pt-2 fs-26">{{count($registeredStudents)}}</h5>
                    </div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div>
            ...
            <div class="card card-item dashboard-info-card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="pl-4">
                        ...
                        <h5 class="card-title pt-2 fs-26">{{count($totalCourses)}}</h5>
                    </div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div><!-- end col-lg-4 -->
