...
<head>
    <title>Cedar Growth Consult</title>
    <meta charset="utf-8" />
            ...
            <div class="bee-row-content">
                ...
                <div class="bee-col bee-col-2 bee-col-w5">
                    ...
                    <div class="bee-block bee-block-2 bee-heading">
                        <img src="{{ asset('frontend/assets/img/logorem.png') }} " alt="" width="130px"
                            height="130px">
                        <h1
                            style="color:red;direction:ltr;font-family:'Roboto Slab', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:74px;font-weight:700;letter-spacing:normal;line-height:120%;text-align:left;margin-top:0;margin-bottom:0;">
                            Cedar Consult Growth<br /> </h1>
                    </div>
        ...
        <div class="bee-row bee-row-5">
            <div class="bee-row-content">
                ...
                <div class="bee-col bee-col-2 bee-col-w8">
                    <div class="bee-block bee-block-1 bee-paragraph">
                        <p><strong>Cedar Growth Consult </strong><br /><strong> {{ $newsletter['title'] }} </strong></p>
                    ...
                    <div class="bee-block bee-block-2 bee-text">
                        <div class="bee-text-content"
                            ...
                            <p style="line-height: 18px; text-align: center;"><span
                                    style="line-height: 18px;">Ilkeston, Derbyshire. DE7 4PX United Kingdom.</span></p>
                            <p style="line-height: 18px; text-align: center;"><span style="line-height: 18px;">
                                    info@cedargrowthconsult.com </span></p>
                            <p style="line-height: 18px; text-align: center;"><span
